...
# Global async HTTP client for LLMs
_llm_client: httpx.AsyncClient | None = None


async def init_llm_clients(settings: Settings) -> None:
    """Initialize shared HTTP client for LLM providers (DeepSeek, Perplexity, etc.)."""
    global _llm_client
...
async def close_llm_clients() -> None:
    """Gracefully close shared HTTP client if it was created."""
    global _llm_client
